...
%>
<form id="pagerForm" method="post" action="/init/quartz/list">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="delete" href="<%=request.getContextPath()%>/init/quartz/delete.action?uuid={sid_user}" target="ajaxTodo" title="确定要删除吗？" warn="请选择一个用户"><span>删除</span></a></li>
