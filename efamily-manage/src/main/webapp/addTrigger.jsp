...
<div class="pageContent">
	...
	<form method="post" action="/init/trigger/add" class="pageForm required-validate" onsubmit="return validateCallback(this)">
		<div class="pageFormContent nowrap" layoutH="97">
			...
			<dl>
				...
				<dd>
					...
					<input type="text" name="triggerInput.name" maxlength="50" class="required" alt="请输入Trigger名称"/>
