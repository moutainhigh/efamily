 ...
 * 2015年7月9日
 */
public class DeviceLunarFutherRequest{
	...
	private List<DeviceLunarRequest> futherLunars;
	...
	public List<DeviceLunarRequest> getFutherLunars() {
		return futherLunars;
	}
	public void setFutherLunars(List<DeviceLunarRequest> futherLunars) {
		this.futherLunars = futherLunars;
	}
