...
public class DeviceParamConfig extends FmlBaseEntity {
	...
	public boolean equals(Object obj) {
		if(obj instanceof DeviceParamConfig == false) return false;
		if(this == obj) return true;
		DeviceParamConfig other = (DeviceParamConfig)obj;
