...
@Service("notyTaskServiceImpl")
public class NotyTaskServiceImpl implements INotyTaskService{
	private static final Logger log= LoggerFactory.getLogger(NotyTaskServiceImpl.class); 
	...
	public void doProcess(NotyTask notyTask) throws ServerException {
		...
		redisQueue.add(queue.getName(), JsonUtils.toJson(notyTask));
