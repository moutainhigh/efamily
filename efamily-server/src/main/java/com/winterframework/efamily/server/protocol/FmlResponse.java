...
public class FmlResponse{
    ...
    public FmlResponse(FmlRequest request){
    	this.encode=request.getEncode();
    	this.encrypt=request.getEncrypt();
    	this.version=request.getVersion();
    	this.extend=request.getExtend(); 
    	this.sessionId=request.getSessionId();
    	this.command=request.getCommand();
    	this.token=request.getToken();
    	this.clinetType=request.getClinetType();
    }
    ...
    public String toString() {
		return "FmlResponse [encode=" + encode + ", encrypt=" + encrypt + ", version=" + version  + ", clinetType=" + clinetType + ", extend=" + extend
