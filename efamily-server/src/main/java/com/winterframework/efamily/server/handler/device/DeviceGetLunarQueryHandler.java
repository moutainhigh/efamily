 ...
 */
@Service("deviceGetLunarQueryHandler")
public class DeviceGetLunarQueryHandler extends AbstractHandler{
	@PropertyConfig("server.url.device")
	private String serverUrl; 
	@PropertyConfig("device.get_lunar_query")
	private String urlPath;
	
	@Override
	protected FmlResponse doHandle(Context ctx, FmlRequest req) throws ServerException { 
		String time=req.getValue("date");
		log.info("response time:"+time); 
