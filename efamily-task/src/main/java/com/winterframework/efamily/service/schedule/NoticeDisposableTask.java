...
*  
*/
public class NoticeDisposableTask {
	...
	public void execute() throws Exception {
		...
		List<EjlRemind> list = ejlRemindServiceImpl.queryAllDisposableRemindForTask();
		...
		for (EjlRemind ejlRemind : list) {
			...
			RemindStruc struc = this.convertEntityToRemindStruc(ejlRemind,
	...
	public Notification notify(UserNotice userNotice){
		if(null!=userNotice){
