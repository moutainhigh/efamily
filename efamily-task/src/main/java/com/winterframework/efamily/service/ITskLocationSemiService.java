...
public interface ITskLocationSemiService extends IEfComLocationSemiService{
	/**
	 * 获取过滤后的前点
	 * @param locationSemi
	 * @return
	...
	void doProcessOriginNew() throws BizException;
	...
	//////////////////////
	//void processAgg(Context ctx, Date timeFrom, Date timeTo) throws BizException;
	//void process(Context ctx, Date timeFrom, Date timeTo) throws BizException;
	void doProcessLocation(Context ctx,Date timeFrom,Date timeTo)throws BizException;
