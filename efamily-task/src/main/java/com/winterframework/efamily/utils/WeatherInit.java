...
public class WeatherInit {
	...
	public static Map<String,String> mapDupli=new HashMap<String,String>();
	public static Map<String,String> map1=new HashMap<String,String>();
	static{
		map1.put("深圳","101280601");
		
	}
	
	static{
//		mapDupli.put("吉林松江", "101060310");
//		mapDupli.put("上海松江","101020900");//上海
		mapDupli.put("北京朝阳", "101010300");//北京
		mapDupli.put("辽宁朝阳", "101071201");
//		mapDupli.put("吉林天池","101060306");
//		mapDupli.put("新疆天池","101130109");
		mapDupli.put("青海河南", "101150304");
		mapDupli.put("内蒙古河南", "101080706");
//		mapDupli.put("青海清水河", "101150507");
//		mapDupli.put("内蒙古清水河", "101080105");
		mapDupli.put("北京通州", "101010600");
		mapDupli.put("江苏通州", "101190509");
//		mapDupli.put("福建金山", "101230508");
//		mapDupli.put("上海金山", "101020700");
		mapDupli.put("江西东乡", "101240411");
		mapDupli.put("甘肃东乡", "101161106");
//		mapDupli.put("四川南溪", "101271104");
//		mapDupli.put("安徽南溪", "101221504");
//		mapDupli.put("云南河口", "101290114");
//		mapDupli.put("山东河口", "101121202");
		mapDupli.put("广西东兴", "101301403");
		mapDupli.put("四川东兴", "101271202");
		mapDupli.put("四川九龙", "101271805");
		mapDupli.put("香港九龙", "101320102");
	}
	...
	static{
		...
		map.put("伊和乌素","101080707");
		map.put("靖安","101240506");
		map.put("荔波","101260412");
		map.put("南沙","101310220");
		...
		map.put("土左旗","101080102");
		map.put("郧西","101201103");
		map.put("兰陵","101120904");
		...
		map.put("达茂旗","101080206");
		map.put("信宜","101282005");
		map.put("来凤","101201007");
		map.put("杜尔伯特","101050905");
		...
		map.put("阿鲁旗","101080603");
		map.put("佛山","101280800");
		map.put("白沙","101310207");
		map.put("类乌齐","101140507");
		...
		map.put("陆河","101282104");
		map.put("阿克塞","101160804");
		...
		map.put("科左中旗","101080503");
		map.put("库伦","101080507");
		...
		map.put("和林","101080104");
		map.put("无棣","101121103");
		map.put("兰考","101180805");
		map.put("科右中旗","101081103");
		...
		map.put("苏右旗","101080907");
		map.put("献县","101090709");
		map.put("大庆","101050901");
		map.put("五台县","101101003");
	...
	private static String dupliKey="朝阳,河南,通州,东乡,东兴,九龙";
	
	public static String getCityWeatherCode(String privoinceName,String cityName){
		//去掉字符串最后的省市
		if(cityName!=null&&cityName.substring(cityName.length()-1, cityName.length()).equals("市")){
			cityName=cityName.substring(0,cityName.length()-1);
		}
		
		if(privoinceName!=null&&privoinceName.substring(privoinceName.length()-1, privoinceName.length()).equals("省")){
			privoinceName=privoinceName.substring(0,privoinceName.length()-1);
		}
//		if(checkDupli(cityName)){
//			return mapDupli.get(privoinceName+cityName);
//		}
	...
	private static boolean checkDupli(String cityName) {
		return dupliKey.contains(cityName);
		
	}


	public static void main(String[] args) {
		System.out.println(getCityWeatherCode("四川省","东兴"));
	}
